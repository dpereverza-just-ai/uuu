...
theme: /
    ...
    state: 
        ...
        a: Jimmy
        script:
            $analytics.setSessionResult("Jimmy")
            $analytics.setComment("Jimmy Comment")
            $analytics.setMessageLabel("Новая тема", "Оценка")
            $analytics.setSessionLabel("Jimmy Session")
            
    state: 
        q!: Jony
        a: Jony
        script:
            $analytics.setSessionResult("Jony")
            $analytics.setComment("Jony Comment")
            $analytics.setMessageLabel("Новая тема", "Оценка")
            $analytics.setSessionLabel("Jony Session")
            
    state: 
        q!: Bob
        a: Bob
        script:
            $analytics.setSessionResult("Bob")
            $analytics.setComment("Bob Comment")
            $analytics.setMessageLabel("Новая тема", "Оценка")
            $analytics.setSessionLabel("Bob Session")
